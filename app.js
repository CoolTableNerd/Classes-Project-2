class School {
  ...
  // Instantiate a PrimarySchool object
  ...
  School.pickSubstituteTeacher(['Jamal Crawford', 'Lou Williams', 'J. R. Smith', 'James Harden', 'Jason Terry', 'Manu Ginobili']);
  
  // Instantiate a HighSchool object
  let alSmith = new HighSchool('Al Smith', 415, ['Baseball', 'Basketball', 'Volleyball', 'Track and Field']);
